...
R scripts posted here were used for creating plots in the aforementioned manuscript (now available at _G3 Genes|Genomes|Genetics_: [https://doi.org/10.1101/2023.07.14.549000](https://doi.org/10.1093/g3journal/jkad283)). The reference genome itself can be found on NCBI, under GenBank accession number GCA_031834385.1, and raw data from Pac-Bio long-read whole genome sequencing can be found on the Sequence Read Archive, under accession number SRX21895170. 
